...
player_score = api.model('Player Score', {
    'score': fields.Integer(required=True, description='Score for the player'),
    'email': fields.String(required=True, description='Player email'),
})

scores = api.model('Player Score', {
    'player1_score': fields.Integer(required=True, description='Score for player1'),
    'player2_score': fields.Integer(required=True, description='Score for player2'),
})

player_names = api.model('Player Score', {
    'player1': fields.String(required=True, description='New player1 name'),
    'player2': fields.String(required=True, description='New player2 name'),
})
